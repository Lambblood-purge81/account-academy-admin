...
import logoImg from "@images/mainLogolg2.png";
      ...
      <div className={`sidebar ${collapsed ? "hide-sidebar" : ""}`}>
        ...
        <Container>
          ...
          <div className="side-nav-wrapper">
                    ...
                    <Card.Header className="d-flex flex-column align-items-start">
                      ...
                      <div className="d-flex align-items-center justify-content-center w-100">
                        <Card.Text className="mb-0 text-nowrap">
                          <img src={dotBlue} alt="Dot" />{" "}
                          {trimLongText(eventData?.topic, 15)}
                        </Card.Text>
                      </div>
                    </Card.Header>
                    <Card.Body>
            ...
            <div
              className={`side-bar-profile ${sideBarStudentEventModal ? "remove-auto" : ""}`}
            >
