...
const NewStudent = () => {
  ...
  const schema = Yup.object({
    ...
    phoneNumber: Yup.string()
      ...
      .test(
        "is-valid-phone",
        "Phone number must be in the correct format country",
        (value) => {
          ...
          return (
            value.startsWith(belgiumPattern) ||
            value.startsWith(netherlandsPattern)
          );
        }
      ),
    country: Yup.string()
  ...
  const getSingleStudentById = async (id) => {
    const response = await axiosWrapper(
      "GET",
      API_URL.GET_STUDENT.replace(":id", id),
      {},
      token
    );
  ...
  const handleFormSubmit = async (values, { resetForm, setSubmitting }) => {
    ...
    const url = studentId
      ? `${API_URL.UPDATE_STUDENT.replace(":id", studentId)}`
      : API_URL.CREATE_STUDENT;
    ...
    <div className="new-student-page-wrapper">
      ...
      <div className="new-student-page">
        <Container fluid className="p-3">
          <h4 className="mb-3 new-student-title">
            {studentId ? "Student Profile" : "Add New Student"}
          </h4>
          <Formik
                ...
                <Row>
                  ...
                  <Col md={6} xs={12}>
                    <PhoneInputField
                      ...
                      label="Phone Number"
                      countriesAllowed={
                        values.country === "Netherlands" ? ["nl"] : ["be"]
                      }
                    />
                  </Col>
                  ...
                  {/* {studentId && (
                    <Col md={6} xs={12} className="mt-2">
                      ...
                      {courses.length === 0 && (
                        <div>
                          <div className="error mt-2">
                            No coach assigned to this student or coach is not
