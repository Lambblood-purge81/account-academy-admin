...
const PublishCourses = ({
  ...
  const handleSubmit = async () => {
    ...
    dispatch({
      ...
      data: { keyOfData: "currentCourse", data: null },
    });
          ...
          <div className="lecture-details-wrapper">
            <div className="lecture-details">
              <div className="lecture-detailpdfLecturess-item lecture-details-2">
                <h1>Lectures</h1>
                <p>
                  {lectures?.length - pdfLectures.length} Video Lectures,{" "}
                  {pdfLectures.length} Document Lectures, {totalQuestions}{" "}
                  Assesments
                </p>
              </div>
