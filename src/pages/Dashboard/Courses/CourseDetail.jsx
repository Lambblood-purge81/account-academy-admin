...
const CourseDetail = () => {
  ...
  const isDetailPage =
    location.pathname === "/admin/courses/details" || "/coach/courses/details";
        ...
        <div className="publish-course-wrapper">
          <div className="card-background">
            <div className="text-heading">
              ...
              <p>{course?.moduleManager?.name || "Account Academy X"}</p>
            </div>
          </div>
          <div className="lecture-details-wrapper">
            <div className="lecture-details">
              <div className="lecture-details-item lecture-details-2">
                <h1>Lectures</h1>
                <p>
                  {course.lectures?.length - course.pdfLectures?.length} Video
                  Lectures, {course.pdfLectures?.length} Document Lectures,{" "}
                  {course?.totalQuestions} Assesments
                </p>
              </div>
            ...
            {role !== "STUDENT" && (
              ...
              >
                <>
                  ...
                  {userInfo?.role !== "ADMIN" &&
                  course?.moduleManager?._id !== userInfo?._id ? (
                    <></>
                  ) : (
                    <>
                      <Button
