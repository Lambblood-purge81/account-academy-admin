...
const Courses = () => {
  ...
  return (
    <div className="course-section">
      <Helmet>
        <title>Courses | Account Academy</title>
      </Helmet>
        ...
        {role === "STUDENT" ? (
          ...
          <div className="d-flex gap-2 flex-wrap">
            <DropdownButton
              ...
              className="dropdown-button"
            >
              {["All Courses", "Active Courses", "Inactive Courses"].map(
                (event) => (
                  <Dropdown.Item
            ...
            <Button className="add-button" onClick={handleCreateClick}>
              <img src={add} alt="" />{" "}
              <span className="ms-1">Add New Course</span>
            </Button>
          </div>
        )}
      </div>
            ...
            {coursesData.map((course, index) => {
              ...
              return (
                <GenericCard
                  ...
                  {...course}
                  onChange={(e) =>
                    handleArchiveChange(e, course?._id, course?.archive)
                  }
