...
const StudentDashboard = lazy(
  () => import("@pages/Dashboard/Dashboard/StudentDashboard")
);
const MeetingRequest = lazy(
  () => import("@pages/Dashboard/Dashboard/Meeting/MeetingRequest")
);
const Coaches = lazy(() => import("@pages/Dashboard/Coaches/Coaches"));
const NewCoach = lazy(
  () => import("@pages/Dashboard/Coaches/NewCoach/NewCoach")
);
const NewStudent = lazy(
  () => import("@pages/Dashboard/Students/NewStudent/NewStudent")
);
const Students = lazy(() => import("@pages/Dashboard/Students/Students"));
const EnrolledCourseDetail = lazy(
  () => import("@pages/Dashboard/Courses/EnrolledCourseDetail")
);
const Courses = lazy(() => import("@pages/Dashboard/Courses/Courses"));
const Events = lazy(() => import("@pages/Dashboard/Events/Events"));
const EventsListing = lazy(
  () => import("@pages/Dashboard/Events/EventsListing/EventsListing")
);
const EventPage = lazy(
  () => import("@pages/Dashboard/Events/EventPage/EventPage")
);
const NewEvent = lazy(
  () => import("@pages/Dashboard/Events/NewEvent/NewEvent")
);
const EventDetails = lazy(() => import("@pages/Dashboard/Events/EventDetails"));

const SingleEvent = lazy(
  () => import("@pages/Dashboard/Events/SingleEvent/SingleEvent")
);
const Feedback = lazy(() => import("@pages/Dashboard/Feedback/Feedback"));
const Checklist = lazy(() => import("@pages/Dashboard/Checklist/Checklist"));
const News = lazy(() => import("@pages/Dashboard/News/News"));
const Payment = lazy(() => import("@pages/Dashboard/Payments/Payments"));
const VisualizeCSV = lazy(
  () => import("@pages/Dashboard/VisualizeCsv/VisualizeCsv")
);
const Settings = lazy(() => import("@pages/Dashboard/Settings/Settings"));
const NewCourse = lazy(() => import("@pages/Dashboard/Courses/AddNewCourse"));
const CourseDetail = lazy(
  () => import("@pages/Dashboard/Courses/CourseDetail")
);
const AllStudents = lazy(() => import("@pages/Dashboard/Courses/AllStudents"));
const ViewProgress = lazy(
  () => import("@pages/Dashboard/Courses/ViewProgress")
);
